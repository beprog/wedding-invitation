...
export const weddingConfig = {
  ...
  main: {
    ...
    backgroundMusic: "/music/aloha.mp3",  // 배경음악 추가
    hiddenMusic: "/music/No_Words_Can_Say__Roy_Kim.mp3",  // 배경음악 추가
  ...
  gallery: {
    ...
    images: [
      "/images/gallery/1.forest_800px.webp",
      "/images/gallery/2.kiss_800px.webp",
      "/images/gallery/3.happy_800px.webp",
      "/images/gallery/4.laughter_800px.webp",
      "/images/gallery/5.seated_800px.webp",
      "/images/gallery/6.dance_800px.webp",
      "/images/gallery/7.suitdress.webp",
      "/images/gallery/8.sea.webp",
      "/images/gallery/9.portuhill_800px.webp",
      "/images/gallery/10.birthday_800px.webp",
      "/images/gallery/11.coupleinblack_800px.webp",
      "/images/gallery/12.bookmonent.webp",
      "/images/gallery/13.fireworks-animated.gif",
    ],
  } as GalleryConfig,

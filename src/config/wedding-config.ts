...
export const weddingConfig = {
  ...
  gallery: {
    ...
    images: [
      "/images/gallery/16.thankcard_ring.jpg",
      "/images/gallery/17.thnakcard_kiss.jpg",
      "/images/gallery/01.weddingday.webp",
      "/images/gallery/02.forest_800px.webp",
      "/images/gallery/03.kiss_800px.webp",
      "/images/gallery/04.happy_800px.webp",
      "/images/gallery/05.laughter_800px.webp",
      "/images/gallery/06.seated_800px.webp",
      "/images/gallery/07.dance_800px.webp",
      "/images/gallery/08.suitdress.webp",
      "/images/gallery/09.sea.webp",
      "/images/gallery/10.portuhill_800px.webp",
      "/images/gallery/11.birthday_800px.webp",
      "/images/gallery/12.coupleinblack_800px.webp",
      "/images/gallery/13.bookmonent.webp",
      "/images/gallery/14.fireworks-animated.gif",
      "/images/gallery/15,thankyoudance.webp",
    ],
  } as GalleryConfig,
